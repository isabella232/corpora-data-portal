...
aws --endpoint-url=http://localhost:4566 secretsmanager update-secret --secret-id corpora/backend/dev/auth0-secret --secret-string '{"client_id":"dev-client-id","client_secret":"dev-client-secret","audience":"dev-client-id","grant_type":"client_credentials","api_base_url":"http://localhost:4011","cookie_name":"cxguser","callback_base_url":"https://localhost:5000","redirect_to_frontend":"http://localhost:8000"}' || true
